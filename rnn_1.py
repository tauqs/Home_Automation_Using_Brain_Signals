...
#def signal_handler(signal,signal_handler):
#	saved_model = saver.save(sess,'./Saved_Models/lstm_model',global_step = i+1)

def run_lstm_model(tensorflow_data,data_,train=True,test=False, batch_size=72, epoch=1000):
