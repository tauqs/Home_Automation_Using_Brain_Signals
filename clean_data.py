...
def main(IDs,source_folder='Collected_11th_Feb',target_dir='Data/Processed_Data'):
	...
	for user_id,file_names in user_files_dict.iteritems():
		for trial in range(len(file_names)):
			...
			f_name = tmp[0]+'_'+tmp[1]+'_'+str(trial_num)+'.csv'
...
if __name__ == '__main__':
	IDs = [2,5,6,7]
	main(IDs,target_dir='Data/Processed_Data_1')
